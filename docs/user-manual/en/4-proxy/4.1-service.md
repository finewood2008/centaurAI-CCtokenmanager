...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (TOKEN MANAGER)
...
After starting the proxy and enabling app takeover, TOKEN MANAGER modifies app configurations:
...
When stopping the proxy, TOKEN MANAGER will:
