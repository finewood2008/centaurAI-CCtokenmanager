...
> **Note**: OpenClaw and Claude Desktop do not currently support TOKEN MANAGER MCP sync. MCP functionality is supported for Claude, Codex, Gemini, OpenCode, and Hermes.

### Toggle Implementation

When enabling an app's toggle, TOKEN MANAGER will:
...
When disabling an app's toggle, TOKEN MANAGER will:
...
If you have already configured MCP servers in CLI tools, you can import them into TOKEN MANAGER:

1. Click the "Import" button
2. Select the app to import from (Claude/Codex/Gemini/OpenCode/Hermes)
3. TOKEN MANAGER reads the existing configuration and imports it
