...
2. TOKEN MANAGER updates the configuration file
...
1. Right-click the TOKEN MANAGER icon in the system tray
...
When switching providers, TOKEN MANAGER modifies the following files:
