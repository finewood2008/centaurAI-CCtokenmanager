...
TOKEN MANAGER provides rich icon customization features:
...
This ensures TOKEN MANAGER and CLI tool configurations stay in sync.
...
When adding a provider, TOKEN MANAGER automatically extracts endpoint URLs from the configuration.
